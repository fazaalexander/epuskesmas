import 'package:epuskesmas/Apoteker/lihatriwayatobat.dart';
...
class ProfileA extends StatelessWidget {
  ...
  final String userEmail = '****@gmail.com';
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const RiwayatPengirimanResep()),
                  );
                },
              ),
            ),
