...
class ResepD extends StatefulWidget {
  const ResepD({super.key});

  @override
  _ResepDState createState() => _ResepDState();
}

class _ResepDState extends State<ResepD> {
  ...
  void _sendPrescription() {
    ...
    kirimResepObat(patientName, _prescriptionList);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Resep obat untuk $patientName telah berhasil dikirim ke apoteker.',
            textAlign: TextAlign.center,
